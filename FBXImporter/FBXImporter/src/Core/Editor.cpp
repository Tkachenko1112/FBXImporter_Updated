...
void Editor::Update(int viewportWidth, int viewportHeight) {
    ...
    _mouseScreenX = MapRange(Input::GetMouseX(), 0, GL::GetWindowWidth(), 0, viewportWidth);
    _mouseScreenZ = MapRange(Input::GetMouseY(), 0, GL::GetWindowHeight(), 0, viewportHeight);
